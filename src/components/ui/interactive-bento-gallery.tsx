  ...
  return (
    <>
      <motion.div
        ...
        className="fixed inset-0 z-10 w-full min-h-screen overflow-hidden backdrop-blur-lg sm:h-[90vh] sm:rounded-lg md:h-[600px] md:rounded-xl"
      >
        <div className="flex h-full flex-col">
          <div className="flex flex-1 items-center justify-center bg-gray-50/50 p-2 sm:p-3 md:p-4">
            <AnimatePresence mode="wait">
              <motion.div
                key={selectedItem.id}
                className="relative h-auto w-full max-w-[95%] aspect-[16/9] max-h-[70vh] overflow-hidden rounded-lg shadow-md sm:max-w-[85%] md:max-w-3xl"
...
const InteractiveBentoGallery: React.FC<InteractiveBentoGalleryProps> = ({
  ...
  return (
    <div className="mx-auto w-full px-6 py-8 sm:px-8 lg:px-12">
      <div className="mb-8 text-center">
        <motion.h2
          className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 bg-clip-text text-3xl font-medium tracking-tight text-transparent dark:from-white dark:via-gray-200 dark:to-white md:text-4xl lg:text-5xl"
        ...
        <motion.p
          className="mt-4 text-sm leading-relaxed text-gray-600 dark:text-gray-400 md:text-base"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
      ...
      <AnimatePresence mode="wait">
        {selectedItem ? (
          ...
          <motion.div
            className="grid auto-rows-[160px] grid-cols-2 gap-3 sm:auto-rows-[82px] sm:grid-cols-3 md:grid-cols-4"
            initial="hidden"
            animate="visible"
            exit="hidden"
            variants={{

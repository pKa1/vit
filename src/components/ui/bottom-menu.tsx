  ...
  return (
    <div className={cn("relative", className)} {...props}>
      ...
      <div 
        ref={menuRef}
        className={cn(
          "h-14 px-2.5 inline-flex justify-center items-center gap-1 overflow-hidden z-10",
      ...
      >
        {items.map((item, index) => (
          <button 
            key={index}
            className="w-11 h-11 rounded-full flex justify-center items-center hover:bg-muted/80 transition-colors"
          ...
          >
            <div className="flex justify-center items-center">
              <div className="w-[22px] h-[22px] flex justify-center items-center overflow-hidden">
